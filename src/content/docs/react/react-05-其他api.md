...
![image](https://notecdn.hrhe.cn//images/docs/react/react-04_其他Api，动画-01.png)

```jsx
const About = lazy(()=>import(/*webpackChunkName:"about"*/))
```

![image](https://notecdn.hrhe.cn//images/docs/react/react-04_其他Api，动画-02.png)
