...
![image](https://notecdn.hrhe.cn//images/docs/javascript/js-16_闭包、高阶函数、ajax-04.png)

![image](https://notecdn.hrhe.cn//images/docs/javascript/js-16_闭包、高阶函数、ajax-05.png)
