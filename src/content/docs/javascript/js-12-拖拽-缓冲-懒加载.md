...
```
![image](https://notecdn.hrhe.cn//images/docs/javascript/js-12_拖拽、缓冲、懒加载-01.png)
...
![image](https://notecdn.hrhe.cn//images/docs/javascript/js-12_拖拽、缓冲、懒加载-02.png)
