...
![image-20200412204637296](https://notecdn.hrhe.cn//images/docs/other/git-01.png)
...
![img](https://notecdn.hrhe.cn//images/docs/other/3412338-53aedee7d8081020.png)
...
![image-20200426124513175](https://notecdn.hrhe.cn//images/docs/other/git-12.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/git-02.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/git-03.png)

2. 点击对勾，之后弹出提示框，提示输入commit

![image](https://notecdn.hrhe.cn//images/docs/other/git-04.png)

3. 点击推送，或者推送到（会提示选择分支）；

![image](https://notecdn.hrhe.cn//images/docs/other/git-05.png)

4. 之后去git里面查看是否已经提交了代码；

![image](https://notecdn.hrhe.cn//images/docs/other/git-06.png)


### vscode切换分支
![image](https://notecdn.hrhe.cn//images/docs/other/git-07.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/git-08.png)

2. 侧边栏工具使用

![image](https://notecdn.hrhe.cn//images/docs/other/git-09.png)

![image](https://notecdn.hrhe.cn//images/docs/other/git-10.png)

3. 右上角实时对比分支修改内容

![image](https://notecdn.hrhe.cn//images/docs/other/git-11.png)
...
![image-20200729003318782](https://notecdn.hrhe.cn//images/docs/other/image-20200729003318782.png)![image-20200814102618851](https://notecdn.hrhe.cn//images/docs/other/image-20200814102618851.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/image-20200715162848585.png)
