...
![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-01.png)



### license协议

![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-03.png)
...
1. 下载
    ...
    ![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-04.png)
...
2. 安装
    ...
    ![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-05.png)

按照提示完成安装即可，安装完成后可以检测一下是否安装成功
    
在cmd命令行输入nvm,如果出现nvm版本号和一系列帮s助指令，则说明nvm安装成功。

![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-06.png)
...
3. 修改settings.txt
    ...
    ![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-07.png)

4. node.js安装
    可以先使用 nvm list 查看本地已安装的版本

    ![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-08.png)

    然后使用 nvm list available 查看所有版本

    ![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-09.png)

    使用 nvm insttall 版本号 安装制定的版本，如nvm install 12.2.0

    ![image](https://notecdn.hrhe.cn//images/docs/other/包管理工具-10.png)
