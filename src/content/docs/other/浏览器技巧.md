...
* ESC   ---- 打开控制台底部的控制栏
  ...
  ![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-01.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-02.png)
```js
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-03.png)

**console.table()**

第一个可以传入对象或数组，第二个参数可选，可以单独放入想要展示的内容；

![img](https://notecdn.hrhe.cn//images/docs/other/console_table.gif)
...
![image](https://notecdn.hrhe.cn//images/docs/other/about$01.gif)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-11.gif)
...
![image-20200629144106288](https://notecdn.hrhe.cn//images/docs/other/image-20200629144106288.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-04.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-09.png)
...
![image-20200805101534220](https://notecdn.hrhe.cn//images/docs/other/image-20200805101534220.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-05.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-06.png)

还可以到设置中，可以自己加需要忽略的库或文件

![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-07.png)

![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-08.png)
...
![img](https://notecdn.hrhe.cn//images/docs/other/add_new_request_breakpoint.png)

也可以直接对network进行断点

![img](https://notecdn.hrhe.cn//images/docs/other/企业微信截图_15959047639023.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/dayjs-demo.gif)
...
![image-20200601141945879](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-12.png)
...
![image-20200601142707823](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-13.png)
...
![image](https://notecdn.hrhe.cn//images/docs/other/浏览器技巧-10.png)
