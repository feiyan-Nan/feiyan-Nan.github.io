...
![image-20200406215427082](https://notecdn.hrhe.cn//images/docs/vue/vue-09_插件开发.png)
...
3. 登录npm账号
   ...
   ![image-20200406220434803](https://notecdn.hrhe.cn//images/docs/vue/vue-09_插件开发_02.png)

4. 进入到项目的根目录，直接输入npm publish就发布成功了，直接到npmjs官网搜索包的name名字就有了；当然也可以直接在项目npm i 名字；

   ![image-20200406220541606](https://notecdn.hrhe.cn//images/docs/vue/vue-09_插件开发_03.png)
