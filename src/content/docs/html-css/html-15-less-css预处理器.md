...
@each $animal in puma,sea-slug,egret {
    .#{$animal}-icon {
       background-image: url('//images/docs/html-css/#{animal}.png')
   }
}

// 编译
.puma-icon {
 background-image: url('//images/docs/html-css/puma.png'); }
.sea-slug-icon {
 background-image: url('//images/docs/html-css/sea-slug.png'); }
.egret-icon {
 background-image: url('//images/docs/html-css/egret.png'); }
.salamander-icon {
 background-image: url('//images/docs/html-css/salamander.png'); }
// 当多个变量数组时
